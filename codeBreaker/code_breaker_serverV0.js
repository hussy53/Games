...
app.post('/post', (req, res) => {
    ...
    if (/*TODO... check if the request action is generateCode*/z['action']=="generateCode"){
			...
			/*TODO... send the response including the JSON text*/JSON.parse(res.query['jsontext']);
			...
			var jsontext = JSON.stringify({
				/*TODO... type of action */'action':'generateCode',
                /*TODO... won or not */'win':'boolean',
				/*TODO... number of match*/'num_match':0,
                /*TODO... number of correct colors*/'num_containing':0,
                /*TODO... number of wrong colors*/'num_not_in':0
...
function generateCode(clientName){
	...
	/*TODO... declare and initialize the code to an empty array*/var code=[];
